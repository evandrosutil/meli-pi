...
echo "========== Criando um carrinho de compras ==========\n"
curl -X POST http://localhost:8080/api/v1/marketplace/fresh-products/orders -H "Authorization: Bearer $output2" -H "Content-Type: application/json" -d '{
	"products":
	[
		{
			"productId": 1,
...
echo "========== Efetivando uma compra ==========\n"
curl -X POST http://localhost:8080/api/v1/customers/marketplace/purchases -H "Authorization: Bearer $output2" -H "Content-Type: application/json"
